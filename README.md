...
* [UP4ROS2](https://github.com/aiplan4eu/UP4ROS2) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2023-05-30 - ROS 2 wrapper for the [AIPlan4EU Unified Planning library](https://github.com/aiplan4eu/unified-planning) ⭐ 319 | 🐛 46 | 🌐 Python | 📅 2026-09-17.
...
* [soar\_ros](https://github.com/THA-Embedded-Systems-Lab/soar_ros) ⭐ 20 | 🐛 4 | 🌐 C++ | 📅 2026-09-17 - ROS 2 package including the Soar cognitive architecture with logic to handle synchronization between ROS and Soar.
