...
[![GitHub](https://img.shields.io/github/license/ros-wg-delib/awesome-ros-deliberation?style=flat-square)](LICENSE) [![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/ros-wg-delib/awesome-ros-deliberation/lint.yml?style=flat-square)](https://github.com/ros-wg-delib/awesome-ros-deliberation/actions) ⭐ 188 | 🐛 0 | 📅 2026-03-16
...
* [PlanSys2](https://github.com/PlanSys2/ros2_planning_system) ⭐ 488 | 🐛 45 | 🌐 C++ | 📅 2026-07-28 - PDDL planning and execution framework, using C++ and behavior trees.
* [MoveIt Task Constructor](https://github.com/ros-planning/moveit_task_constructor) ⭐ 282 | 🐛 117 | 🌐 C++ | 📅 2026-08-03 - MoveIt add-on package that performs skeleton-based task and motion planning.
* [SkiROS2](https://github.com/RVMI/skiros2) ⭐ 231 | 🐛 47 | 🌐 Python | 📅 2025-06-09 - Skill-based platform with behavior trees, PDDL task-planning and knowledge integration.
...
* [UP4ROS2](https://github.com/aiplan4eu/UP4ROS2) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2023-05-30 - ROS 2 wrapper for the [AIPlan4EU Unified Planning library](https://github.com/aiplan4eu/unified-planning) ⭐ 315 | 🐛 41 | 🌐 Python | 📅 2026-08-12.
* [CoSTAR Stack](http://cpaxton.github.io/costar_stack/) - A collaborative system for task automation and recognition.

### Behavior Abstractions

* [AutoAPMS](https://github.com/AutoAPMS) - Modular domain-agnostic framework for developing and executing behaviors with [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,157 | 🐛 54 | 🌐 C++ | 📅 2026-08-05 integrated deeply into the ROS 2 ecosystem.
* [SMACC2](https://github.com/robosoft-ai/SMACC2) ⭐ 368 | 🐛 12 | 🌐 C++ | 📅 2026-08-13 - State machine implementation in C++.
* [BehaviorTree.ROS2](https://github.com/BehaviorTree/BehaviorTree.ROS2) ⭐ 333 | 🐛 47 | 🌐 C++ | 📅 2025-11-25 - ROS 2 wrapper for [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,157 | 🐛 54 | 🌐 C++ | 📅 2026-08-05, an implementation of behavior trees in C++.
* [YASMIN](https://github.com/uleroboticsgroup/yasmin) ⭐ 273 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - State machine implementation for C++ and Python.
* [PyTrees ROS](https://github.com/splintered-reality/py_trees_ros) ⭐ 228 | 🐛 20 | 🌐 Python | 📅 2026-07-16 - ROS 2 wrapper for the [PyTrees](https://github.com/splintered-reality/py_trees) ⭐ 631 | 🐛 29 | 🌐 Python | 📅 2026-07-16 behavior tree library.
...
* [ros\_bt\_py](https://github.com/fzi-forschungszentrum-informatik/ros2_ros_bt_py) ⭐ 113 | 🐛 23 | 🌐 Python | 📅 2026-08-12 - ROS 2 and Python based library for behavior trees, with a ReactJS based web GUI.
...
* [soar\_ros](https://github.com/THA-Embedded-Systems-Lab/soar_ros) ⭐ 19 | 🐛 3 | 🌐 C++ | 📅 2026-08-12 - ROS 2 package including the Soar cognitive architecture with logic to handle synchronization between ROS and Soar.

### Application-Specific Packages

* [pyrobosim](https://github.com/sea-bass/pyrobosim) ⭐ 383 | 🐛 6 | 🌐 Python | 📅 2026-08-03 - ROS 2 enabled 2D mobile robot simulator for behavior prototyping.
...
* [rmf\_task](https://github.com/open-rmf/rmf_task) ⭐ 26 | 🐛 24 | 🌐 C++ | 📅 2026-06-16 - Composable task definitions and multi-robot task allocation (MRTA) planner in C++.
...
* [JdeRobot VisualStates: Visual tool for generating automata based robot behaviors](https://vimeo.com/293530044) - Okan Asik, JdeRobot @ ROSCon 2018 Lightning Talks ([repo](https://github.com/JdeRobot/VisualStates) ⚠️ Archived).
