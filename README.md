...
* [MoveIt Task Constructor](https://github.com/ros-planning/moveit_task_constructor) ⭐ 282 | 🐛 114 | 🌐 C++ | 📅 2026-08-16 - MoveIt add-on package that performs skeleton-based task and motion planning.
...
* [AutoAPMS](https://github.com/AutoAPMS) - Modular domain-agnostic framework for developing and executing behaviors with [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,161 | 🐛 56 | 🌐 C++ | 📅 2026-08-14 integrated deeply into the ROS 2 ecosystem.
* [SMACC2](https://github.com/robosoft-ai/SMACC2) ⭐ 369 | 🐛 3 | 🌐 C++ | 📅 2026-08-17 - State machine implementation in C++.
* [BehaviorTree.ROS2](https://github.com/BehaviorTree/BehaviorTree.ROS2) ⭐ 333 | 🐛 47 | 🌐 C++ | 📅 2025-11-25 - ROS 2 wrapper for [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,161 | 🐛 56 | 🌐 C++ | 📅 2026-08-14, an implementation of behavior trees in C++.
* [YASMIN](https://github.com/uleroboticsgroup/yasmin) ⭐ 274 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - State machine implementation for C++ and Python.
* [PyTrees ROS](https://github.com/splintered-reality/py_trees_ros) ⭐ 228 | 🐛 20 | 🌐 Python | 📅 2026-07-16 - ROS 2 wrapper for the [PyTrees](https://github.com/splintered-reality/py_trees) ⭐ 633 | 🐛 30 | 🌐 Python | 📅 2026-08-15 behavior tree library.
