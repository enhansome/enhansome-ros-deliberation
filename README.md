...
* [UP4ROS2](https://github.com/aiplan4eu/UP4ROS2) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2023-05-30 - ROS 2 wrapper for the [AIPlan4EU Unified Planning library](https://github.com/aiplan4eu/unified-planning) ⭐ 321 | 🐛 47 | 🌐 Python | 📅 2026-09-23.
...
* [rmf\_task](https://github.com/open-rmf/rmf_task) ⭐ 27 | 🐛 25 | 🌐 C++ | 📅 2026-09-25 - Composable task definitions and multi-robot task allocation (MRTA) planner in C++.
