...
* [UP4ROS2](https://github.com/aiplan4eu/UP4ROS2) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2023-05-30 - ROS 2 wrapper for the [AIPlan4EU Unified Planning library](https://github.com/aiplan4eu/unified-planning) ⭐ 320 | 🐛 46 | 🌐 Python | 📅 2026-09-17.
* [CoSTAR Stack](http://cpaxton.github.io/costar_stack/) - A collaborative system for task automation and recognition.

### Behavior Abstractions

* [AutoAPMS](https://github.com/AutoAPMS) - Modular domain-agnostic framework for developing and executing behaviors with [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,213 | 🐛 41 | 🌐 C++ | 📅 2026-09-20 integrated deeply into the ROS 2 ecosystem.
* [SMACC2](https://github.com/robosoft-ai/SMACC2) ⭐ 373 | 🐛 3 | 🌐 C++ | 📅 2026-09-17 - State machine implementation in C++.
* [BehaviorTree.ROS2](https://github.com/BehaviorTree/BehaviorTree.ROS2) ⭐ 339 | 🐛 47 | 🌐 C++ | 📅 2025-11-25 - ROS 2 wrapper for [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,213 | 🐛 41 | 🌐 C++ | 📅 2026-09-20, an implementation of behavior trees in C++.
...
* [soar\_ros](https://github.com/THA-Embedded-Systems-Lab/soar_ros) ⭐ 20 | 🐛 4 | 🌐 C++ | 📅 2026-09-18 - ROS 2 package including the Soar cognitive architecture with logic to handle synchronization between ROS and Soar.

### Application-Specific Packages

* [pyrobosim](https://github.com/sea-bass/pyrobosim) ⭐ 386 | 🐛 6 | 🌐 Python | 📅 2026-09-20 - ROS 2 enabled 2D mobile robot simulator for behavior prototyping.
